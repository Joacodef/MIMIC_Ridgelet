...
def test_validate_calculates_auc_correctly():
    ...
    assert val_precision == 1.0
    assert val_accuracy == 1.0
    assert cm is not None  # Ensure confusion matrix is returned

# --- Integration "Smoke Test" ---

@patch('src.training.train.validate', return_value=(0.5, 0.95, 0.90, 0.92, 0.98, 0.97, None))
